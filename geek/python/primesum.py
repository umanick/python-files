...
def main():
    ...
    #print(timeit.timeit('primeSum({})'.format(t), globals=globals(), number=10000))
    #print(timeit.timeit('primeSum3({})'.format(t), globals=globals(), number=10000))
    for i in range(t):
        n = int(input())
        #if n>lt:
        #    lt = n
        #    primes = primesnew = erat(n)
        #else:
        #    primesnew = primes
        #    for x in primesnew:
        #        if x>n:
